...
here is the code for user check and delete menu code
*/
...
<!--
	Html code for delete menu and update box
	-->
	...
	<div class="right_area">
		...
		<hr>
			...
			<?php for($x=1;$x<=$result_super->num_rows;$x++): ?>
				...
				<?php $row_img = $result_super->fetch_assoc();  ?>
					
					<input type="image" name='name[<?php  echo $row_img["image_path"];?>]' src="<?php  echo $row_img["image_path"];?>" alt="Submit Form" height="200px" width="100%" />
